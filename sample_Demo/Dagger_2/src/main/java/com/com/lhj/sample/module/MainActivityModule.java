...
/*    private final ConstrctMainActivity.ViewActivity mViewActivity;

    public MainActivityModule(ConstrctMainActivity.ViewActivity viewActivity){
        this.mViewActivity = viewActivity;
    }

    @Provides
    public ConstrctMainActivity.ViewActivity providesConstrctActivity(){
